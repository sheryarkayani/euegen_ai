...
*Onboarding plan generated by Gina's AI — The Med Spa Matchmaker Intelligence Platform*`
    ...
    <div className="space-y-4">
      <Card>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <label className="text-xs text-gray-400 mb-1.5 block">Experience Required</label>
          ...
          <div>
            <label className="text-xs text-gray-400 mb-1.5 block">Schedule</label>
      ...
      {loading && !output && <div className="flex justify-center py-8"><GinaTyping message="Writing your job description..." /></div>}
    </div>
  )
}
...
function CompBenchmarks() {
  return (
    <Card>
      ...
      <div className="mt-4 p-3 rounded-xl" style={{ background: 'rgba(212,168,83,0.06)', border: '1px solid rgba(212,168,83,0.15)' }}>
        <p className="text-xs text-gray-400"><span className="text-gold-500 font-medium">Gina's note:</span> These are US national ranges. Austin, TX, and other high-cost metros run 10–20% above base. Don't try to underpay injectors — the market has shifted. A good NP knows what they're worth.</p>
      </div>
    </Card>
  )
}
...
function OnboardingKitGenerator() {
  ...
  return (
    <div className="space-y-4">
      <Card>
        ...
        <div className="flex gap-4 items-end">
          <div className="flex-1">
            <label className="text-xs text-gray-400 mb-1.5 block">Role to Onboard</label>
      ...
      {loading && !output && <div className="flex justify-center py-8"><GinaTyping message="Building your onboarding kit..." /></div>}
    </div>
  )
}
