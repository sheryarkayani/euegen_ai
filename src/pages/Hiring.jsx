...
*Onboarding plan generated by Eugene's AI — Fractional CFO & Scaling Advisory*`
...
function JobDescriptionGenerator() {
  ...
  return (
    <div className="space-y-4">
      ...
      {loading && !output && <div className="flex justify-center py-8"><EugeneTyping message="Writing your job description..." /></div>}
    </div>
  )
}
  ...
  return (
    <Card>
      ...
      <div className="mt-4 p-3 rounded-xl" style={{ background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.15)' }}>
        <p className="text-xs text-gray-500"><span className="text-indigo-600 font-semibold">Eugene's CFO note:</span> These are US national ranges. Austin, TX, and other high-cost metros run 10–20% above base. Don't try to underpay injectors — the market has shifted. A good NP knows what they're worth.</p>
      </div>
    </Card>
  )
}
...
function OnboardingKitGenerator() {
  ...
  return (
    <div className="space-y-4">
      ...
      {loading && !output && <div className="flex justify-center py-8"><EugeneTyping message="Building your onboarding kit..." /></div>}
    </div>
  )
}
